...
FROM (SELECT PR.NOMBRE PRODUCTO, DP.CANTIDAD * DP.PRECIO_UNIDAD VENTAS, EXTRACT (YEAR FROM P.FECHA_ENTREGA) ANIO
FROM PEDIDO P
...
---------------------ROLLUP------------------------------
SELECT PRODUCTO, ANIO, ESTADO, SUM(VENTAS) VENTAS FROM(
