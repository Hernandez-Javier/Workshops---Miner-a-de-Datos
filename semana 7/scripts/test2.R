...
datos<-read.csv(file = "file/Pasajeros.csv",header = T,sep = ",",encoding = "UTF-8")
...
datos$aeropuerto<-str_trim(str_replace(datos$aeropuerto,"Aeropuerto Internacional","")) #cambiar el nombre del aeropuerto
